...
export class AboutComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.seoService.updateSEO({
      ...
      keywords: 'о компании MOTOмаркет, о нас, история компании, мототехника Дзержинск, интернет-магазин мототехники Нижегородская область, магазин мототехники Дзержинск',
