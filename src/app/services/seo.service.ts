...
export class SeoService {
  ...
  private readonly defaultDescription = 'В интернет-магазине MOTOмаркет вы можете купить запчасти, экипировку и аксессуары для мотоциклов, скутеров, квадроциклов и снегоходов. Широкий ассортимент, выгодные цены, профессиональная поддержка и быстрая доставка мототехники по Нижегородской области. Предоставляется рассрочка 0%. Надежные мототовары с гарантией.';
