...
export class SeoService {
  ...
  private readonly defaultDescription = 'MOTOмаркет - интернет-магазин мототехники в Дзержинске, ул. Гайдара 61 д. Мотоциклы, квадроциклы, скутеры, мопеды, питбайки, экипировка, зимняя техника, аксессуары, запасные части, масла и смазки. Техника б/у. Доставка по Дзержинску и Нижегородской области. Рассрочка 0% без переплат. Гарантия качества.';
